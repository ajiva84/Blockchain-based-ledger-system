...
# YOUR CODE HERE
input_sendor = st.text_input("Sender")
# @TODO:
...
# YOUR CODE HERE
input_amount = st.number_input(label="enter amount here",step=1.,format="%.2f")
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(input_sendor, input_receiver, input_amount),
        creator_id=42,
